...
<<<<<<< HEAD
const roleIdx  = ref(0)
const roleText = ref(t.value.home.roles[0])
let tid = null
onMounted(() => {
  tid = setInterval(() => {
    roleIdx.value = (roleIdx.value + 1) % t.value.home.roles.length
    roleText.value = t.value.home.roles[roleIdx.value]
  }, 3000)
})
=======
    ...
    <div class="max-w-6xl mx-auto w-full relative">
      <div class="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div class="space-y-8 order-2 lg:order-1">
          <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-em-light/20 dark:border-em/20 bg-em-light/5 dark:bg-em/5">
            <span class="w-1.5 h-1.5 rounded-full bg-em-light dark:bg-em animate-pulse-em"></span>
            <span class="section-label">{{ t.home.available }}</span>
          </div>
          <div>
            <p class="text-sm font-medium text-lt-muted dark:text-dk-muted mb-3">{{ t.home.greeting }}</p>
=======
...
<<<<<<< HEAD
          <div class="flex items-center gap-3 h-7">
            ...
            <Transition name="role" mode="out-in">
              <p :key="roleText" class="text-sm font-medium text-em-light dark:text-em">{{ roleText }}</p>
            </Transition>
          </div>
          <p class="body-text max-w-md leading-7">{{ t.home.description }}</p>
=======
...
<<<<<<< HEAD
          <div class="flex items-center gap-4 pt-1">
            <span class="text-xs text-lt-muted dark:text-dk-muted">{{ t.home.find_me }}</span>
=======
...
<<<<<<< HEAD
        ...
        <div class="flex justify-center order-1 lg:order-2">
          <div class="relative animate-float">
            <div class="w-64 h-64 md:w-[300px] md:h-[300px] rounded-2xl overflow-hidden border border-lt-border dark:border-dk-border bg-lt-section dark:bg-dk-section">
              <img v-if="imgSrc" :src="imgSrc" @error="imgError" alt="Styve M'BOUMBA" class="w-full h-full object-cover object-center" />
=======
        <!-- ── Droite : photo ── -->
        <div class="flex justify-center order-1 lg:order-2">
          <div class="relative animate-float">
...
<<<<<<< HEAD
                <p class="text-xs text-lt-muted dark:text-dk-muted text-center leading-relaxed">Ajouter Image_acceuil.jpeg<br>dans src/assets/</p>
              </div>
            </div>
            <div class="absolute -bottom-5 -left-5 card px-4 py-3 shadow-lg">
              ...
              <p class="text-xs text-lt-muted dark:text-dk-muted">{{ t.home.years }}</p>
            </div>
            <div class="absolute -top-4 -right-4 card px-3 py-2 shadow-lg">
              <div class="flex items-center gap-1.5">
                <span class="w-1.5 h-1.5 rounded-full bg-em-light dark:bg-em animate-pulse-em"></span>
                <span class="text-xs font-medium text-lt-text dark:text-dk-text">{{ t.home.open_to_work }}</span>
=======
...
>>>>>>> f0432618e88b35a4b0ca94eb8713086482e3c474
      ...
      <div class="mt-24 grid grid-cols-3 gap-px bg-lt-border dark:bg-dk-border rounded-xl overflow-hidden">
        <div v-for="s in [
<<<<<<< HEAD
          {v:'3+', lk:'years_exp'},{v:'10+',lk:'projects_done'},{v:'3',lk:'domains'}
        ]" :key="s.lk" class="py-7 text-center bg-lt-bg dark:bg-dk-bg">
          <p class="font-semibold text-2xl tracking-tight text-em-light dark:text-em">{{ s.v }}</p>
          <p class="text-xs text-lt-muted dark:text-dk-muted mt-1">{{ t.home[s.lk] }}</p>
=======
